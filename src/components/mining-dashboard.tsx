...
export function MiningDashboard() {
  ...
  return (
    <div className="min-h-screen bg-background pb-24">
      ...
      <div className="px-2 py-1 sm:px-4 sm:py-2 space-y-3 sm:space-y-4">
        <div className="relative min-h-[280px] xs:min-h-[320px] sm:min-h-[380px] w-full rounded-[2rem] sm:rounded-[2.5rem] overflow-hidden border border-border bg-card shadow-xl">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full px-4 xs:px-6 flex flex-col items-center">
            {isSessionActive ? (
              <div className="flex flex-col items-center animate-in zoom-in-95 duration-500 w-full max-w-md">
                <span className="text-primary/40 text-[7px] xs:text-[8px] sm:text-[10px] font-black uppercase tracking-[0.5em] mb-1 xs:mb-2">Live Session Counter</span>
                <div className="relative mb-2 xs:mb-4 sm:mb-6">
                ...
                <div className="flex items-center gap-2 xs:gap-3 sm:gap-4 bg-primary/10 px-5 py-2 xs:px-6 xs:py-2 sm:px-8 sm:py-2.5 rounded-full border border-primary/20 shadow-lg mb-3 xs:mb-4 sm:mb-6">
                ...
                <div className="w-full max-w-[240px] xs:max-w-[280px] sm:max-w-[320px] space-y-2 xs:space-y-3">
              ...
              <div className="flex flex-col items-center animate-in fade-in duration-700 w-full max-w-sm">
                ...
                <Button 
                  ...
                  disabled={isStarting}
                  className="w-full h-14 xs:h-16 sm:h-20 rounded-2xl xs:rounded-[1.5rem] bg-primary hover:bg-primary/90 text-primary-foreground font-black text-base xs:text-lg sm:text-xl uppercase tracking-tighter shadow-xl active:scale-95 transition-all border-b-4 border-primary/80 active:border-b-0"
                >
