  ...
  return (
    <div className="min-h-screen bg-background pb-24">
      ...
      <div className="px-2 pt-0 pb-4 sm:px-4 sm:pt-0 space-y-3 sm:space-y-4">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full px-4 xs:px-6 flex flex-col items-center">
            {isSessionActive ? (
              <div className="flex flex-col items-center animate-in zoom-in-95 duration-500 w-full max-w-md">
                <span className="text-primary/40 text-[7px] xs:text-[8px] sm:text-[10px] font-black uppercase tracking-[0.5em] mb-1">Live Session Counter</span>
                ...
                <div className="w-full max-w-[240px] xs:max-w-[280px] sm:max-w-[320px] space-y-2">
                  <div className="relative">
                      ...
                      <div 
                          className="absolute inset-0 h-1.5 xs:h-2 bg-gradient-to-r from-primary to-accent blur-sm opacity-50 transition-all duration-1000" 
                  ...
                  <div className="grid grid-cols-2 gap-2 sm:gap-3 pt-1">
                    <button 
                      ...
                      className="h-12 xs:h-14 sm:h-16 rounded-xl xs:rounded-2xl bg-secondary border border-border hover:bg-accent text-foreground flex flex-col items-center justify-center gap-0.5 group transition-all shadow-sm"
                    >
                    ...
                    <button 
                      ...
                      className="h-12 xs:h-14 sm:h-16 rounded-xl xs:rounded-2xl bg-secondary border border-border hover:bg-accent text-foreground flex flex-col items-center justify-center gap-0.5 group disabled:opacity-50 transition-all shadow-sm"
                    >
                      {isProcessing === 'turbo' ? (
                          <Loader2 className="animate-spin h-3.5 w-3.5 xs:h-4 sm:h-5" />
                      ) : (
                          <>
                              <Zap className="h-3.5 w-3.5 xs:h-4 sm:h-5 text-primary group-hover:animate-pulse" />
              ...
              <div className="flex flex-col items-center animate-in fade-in duration-700 w-full max-w-sm">
                ...
                <Button 
                  ...
                  disabled={isStarting}
                  className="w-full h-14 xs:h-16 rounded-2xl bg-primary hover:bg-primary/90 text-primary-foreground font-black text-base xs:text-lg sm:text-xl uppercase tracking-tighter shadow-xl active:scale-95 transition-all border-b-4 border-primary/80 active:border-b-0"
                >
                  {isStarting ? <Loader2 className="animate-spin mr-2 h-4 w-4" /> : <Play className="mr-2 h-4 w-4 fill-current" />}
                  Initialize Node
                </Button>
                <p className="text-muted-foreground text-[7px] xs:text-[8px] sm:text-[9px] font-black tracking-[0.2em] mt-4 uppercase text-center max-w-[160px] leading-relaxed">
                  Terminal standby: begin cycle
                </p>
              </div>
            )}
          </div>
        ...
        <div 
          onClick={() => setIsRateBreakdownOpen(true)}
          className="rounded-2xl xs:rounded-[2rem] p-4 xs:p-6 sm:p-8 relative overflow-hidden bg-card border border-border cursor-pointer transition-all hover:bg-secondary/20 active:scale-[0.99] shadow-md"
        >
          ...
          <div className="flex justify-between items-center mb-4 sm:mb-6">
            ...
            <div className="px-2 py-0.5 rounded-full bg-secondary border border-border">
              <span className="text-foreground/80 font-mono text-[6px] xs:text-[8px] font-bold tracking-widest uppercase">
        ...
        <div className="px-2 py-3 border-t border-border flex justify-between items-center text-muted-foreground/40">
          <div className="flex items-center gap-2 sm:gap-4">
              <div className="flex items-center gap-1">
                  <Cpu className="h-2 w-2 sm:h-3 sm:w-3" />
                  <span className="text-[6px] sm:text-[9px] font-bold uppercase tracking-widest">Optimized_CPU</span>
              </div>
              <div className="flex items-center gap-1">
                  <Network className="h-2 w-2 sm:h-3 sm:w-3" />
                  <span className="text-[6px] sm:text-[9px] font-bold uppercase tracking-widest">Hills_Net</span>
              </div>
          </div>
