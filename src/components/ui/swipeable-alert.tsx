...
const SwipeableAlert = React.forwardRef<
...
SwipeableAlert.displayName = 'SwipeableAlert'

const SwipeableAlertTitle = React.forwardRef<
...
SwipeableAlertTitle.displayName = 'SwipeableAlertTitle'

const SwipeableAlertDescription = React.forwardRef<
...
SwipeableAlertDescription.displayName = 'SwipeableAlertDescription'

const SwipeableAlertClose = React.forwardRef<
...
SwipeableAlertClose.displayName = 'SwipeableAlertClose'

export { SwipeableAlert, SwipeableAlertTitle, SwipeableAlertDescription, SwipeableAlertClose, ToastProvider }